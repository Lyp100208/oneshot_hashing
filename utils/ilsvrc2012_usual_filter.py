...
def create_filtered_usual(map_per_class_list,usual_data_dict):
	...
	f=open("./data/ilsvc2012/100_600/filtered_usual.txt","w+")
...
if __name__=="__main__":
	...
	usual_data_dict=read_usual("./data/ilsvc2012/100_600/train_usual.txt")
	query_list=read_query_list(["./feature/ilsvrc2012/googlenet_usual_48/val_feature.txt","./feature/ilsvrc2012/googlenet_usual_48/val_label.txt"])             
	db_list=read_db_list(["./feature/ilsvrc2012/googlenet_usual_48/train_feature.txt","./feature/ilsvrc2012/googlenet_usual_48/train_label.txt","./feature/ilsvrc2012/googlenet_usual_48/test_feature.txt","./feature/ilsvrc2012/googlenet_usual_48/test_label.txt"])
	...
	f=open("./data/ilsvc2012/100_600/map_per_class.txt","w+")
